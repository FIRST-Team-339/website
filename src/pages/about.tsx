      ...
      <div className="py-24 min-h-dvh text-gray-950 md:text-gray-50 md:bg-black md:bg-opacity-40 md:bg-blend-overlay md:bg-[url('/assets/img/about_page_banner_blurred.png')] bg-cover bg-left">
        <div className="flex flex-col mx-8">
          ...
          <div className="flex flex-col md:flex-row lg:mx-16">
            <Image src={KilroyTransparent} alt="FIRST Logo" className="aspect-square md:h-36 w-auto mx-auto md:mr-20"/>
            <div className="flex flex-col gap-y-8">
              <p className="text-lg justify-center">Kilroy was founded in 1999, and our Rookie Year was 2000. Kilroy is a FIRST Robotics team dedicated to inspiring an interest in Science, Technology, Engineering, and Math among high school students in Stafford County, Virginia.</p>
            </div>
          </div>
