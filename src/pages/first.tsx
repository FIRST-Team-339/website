...
export default function FIRSTPage() {
  return (
    <>
      <Head>
        <title>FIRST™️ — Kilroy Robotics</title>
        <meta name="title" content="FIRST™️ — Kilroy Robotics" />
      ...
      <div className="py-24 min-h-dvh">
        <div className="flex flex-col mx-8">
          ...
          <div className="flex flex-col md:flex-row lg:mx-16">
            <Image src={FIRSTLogo} alt="FIRST™️ Logo" className="md:h-36 mx-auto md:mr-20"/>
            <div className="flex flex-col gap-y-8">
              <p className="text-lg justify-center text-gray-950">FIRST™️ was founded in 1989 to inspire young people to be science and technology leaders, by engaging them in exciting mentor-based programs that build science, engineering and technology skills, that inspire innovation, and that foster well-rounded life capabilities including self-confidence, communication, and leadership.</p>
              <p className="text-lg justify-center text-gray-950"><span className="font-bold">Gracious Professionalism</span> and <span className="font-bold">Coopertition</span> are integral parts of the ethos of FIRST™️. <span className="font-bold">Gracious Professionalism</span> is a way of doing things that encourages high-quality work, emphasizes the value of others, and respects individuals and the community. <span className="font-bold">Coopertition</span> is displaying unqualified kindness and respect in the face of fierce competition, and is founded on the philosophy that teams can and should help and cooperate with each other even as they compete.</p>
              <p className="text-lg justify-center text-gray-950">With these tenets, fierce competition and mutual gain are not separate notions. Successful FIRST™️ teams assist and enable others whenever they can.</p>
          ...
          <div className="flex flex-col gap-y-8 lg:mx-16">
            <p className="text-lg justify-center text-gray-950">FIRST™️ has a wide range of support, resources, and opportunities for alumni.</p>
            <p className="text-lg justify-center text-gray-950">FIRST™️ Alumni have access to special scholarships. You can view those scholarship opportunities <Link href="https://www.firstinspires.org/alumni/scholarships" className="hover:underline text-orange-500">here</Link>.</p>
          </div>
        </div>
      </div>
    </>
